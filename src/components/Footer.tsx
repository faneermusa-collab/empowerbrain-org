        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-ink-400">
              Creative Education for a Creative Generation. Master mental math with patented abacus methods
              and the Zargelin Mathematical Chain.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li><Link to="/programs" className="hover:text-brand-400 transition-colors">Our Program</Link></li>
              <li><Link to="/courses" className="hover:text-brand-400 transition-colors">Browse Courses</Link></li>
              <li><Link to="/calculator" className="hover:text-brand-400 transition-colors">ZMC Trainer</Link></li>
              <li><Link to="/franchise" className="hover:text-brand-400 transition-colors">Franchise</Link></li>
              <li><Link to="/countries" className="hover:text-brand-400 transition-colors">Country Portals</Link></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><a href="https://empowerbrain.org/who-we-are/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-400 transition-colors">Who We Are</a></li>
              <li><a href="https://empowerbrain.org/vision-and-mission/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-400 transition-colors">Vision & Mission</a></li>
            </ul>
          </div>
