        ...
        >
          {hasChildren ? (
            <button onClick={() => toggleNode(member.id)} className="text-ink-400 hover:text-ink-700">
              {isExpanded ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4 rtl-flip" />}
            </button>
          ) : (
            <div className="w-4" />
          )}
              ...
              {downline.length === 0 ? (
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 rounded-xl bg-brand-50 px-3 py-2.5">
                    ...
                    >
                      {expandedNodes.has(profile?.id ?? '') ? <ChevronDown className="h-4 w-4" /> : <ChevronRight className="h-4 w-4 rtl-flip" />}
                    </button>
